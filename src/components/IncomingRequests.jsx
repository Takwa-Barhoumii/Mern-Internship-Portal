          ...
          <tbody className="divide-y divide-gray-200">
            {requests.map((request, index) => (
              <tr key={index}>
                ...
                <td className="whitespace-nowrap px-4 py-2 text-gray-700">{request.name}</td>
                <td className="whitespace-nowrap px-4 py-2 text-gray-700">{request.email}</td>
                <td className="whitespace-nowrap px-4 py-2 text-blue-500 underline underline-offset-2 under">
                  <a href={request.resumeLink} target="_blank" rel="noopener noreferrer">View Resume</a>
                </td>
              </tr>
            ))}
          </tbody>
